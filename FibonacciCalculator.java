...
public class FibonacciCalculator {
	...
	public static void main(String [] args) {
		...
		//Creates a new scanner to ask user what number they would like to calculate to
		Scanner intReader = new Scanner(System.in);
		System.out.println("Input what value you would like the fibonnaci calculator"
				+ " to calculate up to: ");
		...
		System.out.println("To perform this calculation it took "
	 ...
	 * @param number to be calculated up to
